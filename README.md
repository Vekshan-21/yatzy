...
<div align="center">
  <img width="49%" alt="FasterRCNN_kitti_evo" src="./versions/v01/docs/Draw.png">
  <img width="49%" alt="FasterRCNN_kitti_tmevo" src="./versions/v01/docs/Draw.png">
...
<div align="center">
  <img width="49%" alt="FasterRCNN_coco_evo" src="./versions/v01/docs/Draw.png">
  <img width="49%" alt="FasterRCNN_coco_tmevo" src="./versions/v01/docs/Draw.png">
  <span style="text-align: center; display: inline-block; width:49%">(a)</span>
  <span style="text-align: center; display: inline-block; width:49%">(b)</span>
</div>

<div align="center">
  <img width="49%" alt="Detr_coco_evo" src="./versions/v01/docs/Draw.png">
  <img width="49%" alt="Detr_coco_tmevo" src="./versions/v01/docs/Draw.png">
  <span style="text-align: center; display: inline-block; width:49%">(c)</span>
  <span style="text-align: center; display: inline-block; width:49%">(d)</span>
</div>
...
<div align="center">
  <img width="500px" alt="Plot Results" src="./versions/v01/docs/Draw.png">
</div>
